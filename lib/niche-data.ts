...
export const NICHE_PACKS: NichePack[] = [
  {
    ...
    label: "Education",
    code: "EDU",
    message: "Do you have weekend IELTS classes near the city center?",
  ...
  },
  {
    ...
    label: "Real Estate",
    code: "EST",
    message: "I need a two-bedroom apartment near downtown.",
    questions: ["Buy or rent?", "Budget range?", "Furnished?", "Schedule a viewing?"],
    fields: [
      { label: "Intent", value: "Rent" },
      { label: "Budget", value: "$2,800–$3,500/month" },
